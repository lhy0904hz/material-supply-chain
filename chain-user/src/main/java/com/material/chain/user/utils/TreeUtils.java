...
public class TreeUtils {
    public static void main(String[] args) {
        ...
        //System.out.println(testFunction(2, i -> 5 * i + 2, j -> j + j));
        List<Integer> list = new ArrayList<>();
        list.add(1);
        list.add(2);
        list.add(3);
        list.add(4);
        Optional<Integer> any = list.stream().filter(i -> i.equals(5)).findAny();
        any.ifPresent(System.out::println);

    }

    public static int testFunction(int i, Function<Integer, Integer> function, Function<Integer, Integer> function2) {
        return function.compose(function2).apply(i);
